<template>
  <div>
    ...
    <p>
      ...
      <a href="https://kusama.polkassembly.io/motion/256"
    ...
    <p>
      ...
      as
      <a href="https://github.com/kodadot/nft-gallery/issues"
    ...
    <p>
      ...
      and introduce <b>small fee through minting</b> through KodaDot, we will be
    ...
    <p>
      ...
      <b
        ><a href="https://hackmd.io/cy3jpAhvR-S32SUiMqEabg?edit"
          >artists-support-program</a
        ></b
      >
      which will flow back to artists. We are trying to create self-reinforcment
      accrual cycle, where you as creator supporting KodaDot gallery will flow
    ...
    <br />
    <h1 class="title is-4">
      <a href="https://www.dictionary.com/browse/sustainability"
